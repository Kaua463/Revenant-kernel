...
grep -q 'KSU_VERSION_FORCED: 33214' "$workflow"
grep -q 'KSU_VERSION_TAG: v3.3.0' "$workflow"
grep -q 'configs/dyperos-stock-ksun.fragment' "$workflow"
! grep -q 'CONFIG_KSU_SUSFS' configs/dyperos-stock-ksun.fragment
! grep -q 'CONFIG_RODIN' configs/dyperos-stock-ksun.fragment
