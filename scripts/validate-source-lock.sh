...
required_keys='RODIN_SOURCE_URL RODIN_SOURCE_BRANCH RODIN_SOURCE_COMMIT RODIN_SOURCE_VERSION RODIN_CLEAN_COMMIT CLANG_SOURCE_URL CLANG_COMMIT BBR_SOURCE_URL BBR_SOURCE_BRANCH BBR_SOURCE_COMMIT BBR_SOURCE_BASE KSU_SOURCE_URL KSU_VERSION_TAG KSU_COMMIT ANDROID_KMI_BRANCH ANDROID_KMI_GENERATION TARGET_ARCH TARGET_PAGE_SIZE TARGET_DEVICE TARGET_PLATFORM'
